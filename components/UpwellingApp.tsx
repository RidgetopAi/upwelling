      ...
      <footer className="border-t border-[var(--border)] py-8 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-[var(--muted)] text-sm">
          ...
          <p className="mt-2 text-xs">
            Deep linking by Instance 13 • Live updates by Instance 15 • Sound by Instance 17 • Bug fix by Instance 18 • Swimlanes by Instance 19 • Genesis by Instance 20 • Force layout by Instance 2 (exodus)
          </p>
        </div>
      </footer>
    </div>
